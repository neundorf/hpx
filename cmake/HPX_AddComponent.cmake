...
macro(add_hpx_component name)
  ...
  if(${name}_EXCLUDE_FROM_ALL)
    ...
    if(DEFINED CMAKE_INSTALL_LIBDIR)
      set(_HPX_ADD_COMP_LIBDIR "${CMAKE_INSTALL_LIBDIR}")
    elseif(DEFINED LIB)
      set(_HPX_ADD_COMP_LIBDIR "${LIB}")
    else()
      set(_HPX_ADD_COMP_LIBDIR "lib/")
    endif()

    if(${name}_PLUGIN AND NOT HPX_WITH_STATIC_LINKING)
      set(install_destination ${_HPX_ADD_COMP_LIBDIR}/hpx)
      set(${name}_OUTPUT_SUFFIX hpx)
    else()
      set(install_destination ${_HPX_ADD_COMP_LIBDIR})
    endif()
